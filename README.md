...
### Limitations
Images with two consective numbers cannot be calssified and requires network to be optimized accordingly currently it needs batch data of images and tensors of values ranging from 0 to 9 but currently working on model to use handwritten data as a input.
